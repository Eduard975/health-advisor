          ...
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <Button
                type="button"
                variant="outline"
                className="w-full hover:bg-primary hover:text-primary-foreground hover:border-primary focus:bg-primary focus:text-primary-foreground focus:border-primary active:bg-primary-dark"
                size="lg"
              >
